...
UBUNTU_TRANSLATION_DOMAIN="surucolors.mateo-salta"
...
aptest.commands = bash $$PWD/surucolors/tests/autopilot/run
aptest.depends  = sub-surucolors

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/surucolors/tests/unit 
unittest.depends  = sub-surucolors
